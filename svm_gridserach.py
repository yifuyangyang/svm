...
# ========== 3. 指定你的训练集 / 测试集目录 ==========
train_dir = r"C:\Users\whisper\Desktop\机器学习\svm\dataset\trainingDigits"# 改成你的 402 个训练文件所在文件夹
test_dir  = r"C:\Users\whisper\Desktop\机器学习\svm\dataset\testDigits"       # 改成你的 186 个测试文件所在文件夹
