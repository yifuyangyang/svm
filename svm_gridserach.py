...
# ========== 3. 指定你的训练集 / 测试集目录 ==========
train_dir = r"C:\Users\l\Desktop\gi\svm\dataset\trainingDigits"   # 改成你的 402 个训练文件所在文件夹
test_dir  = r"C:\Users\l\Desktop\gi\svm\dataset\testDigits"       # 改成你的 186 个测试文件所在文件夹
...
best_clf = grid_search.best_estimator_
print(f"最优模型参数：C={best_clf.C}, gamma={best_clf.gamma}")
